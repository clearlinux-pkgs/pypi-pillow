...
Source0  : https://files.pythonhosted.org/packages/cd/74/ad3d526f3bf7b6d3f408b73fde271ec69dfac8b81341a318ce825f2b3812/pillow-10.4.0.tar.gz
...
%prep
%setup -q -n pillow-10.4.0
cd %{_builddir}/pillow-10.4.0
%patch -P 1 -p1
pushd ..
cp -a pillow-10.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720052534
