...
Source0  : https://files.pythonhosted.org/packages/f3/0d/d0d6dea55cd152ce3d6767bb38a8fc10e33796ba4ba210cbab9354b6d238/pillow-11.3.0.tar.gz
...
%prep
%setup -q -n pillow-11.3.0
cd %{_builddir}/pillow-11.3.0
%patch -P 1 -p1
pushd ..
cp -a pillow-11.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751378451
