...
Source0  : https://files.pythonhosted.org/packages/af/cb/bb5c01fcd2a69335b86c22142b2bccfc3464087efb7fd382eee5ffc7fdf7/pillow-11.2.1.tar.gz
...
%prep
%setup -q -n pillow-11.2.1
cd %{_builddir}/pillow-11.2.1
%patch -P 1 -p1
pushd ..
cp -a pillow-11.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744639171
