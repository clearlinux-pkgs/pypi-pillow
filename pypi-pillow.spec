...
Source0  : https://files.pythonhosted.org/packages/03/a3/f61a9a7ff7969cdef2a6e0383a346eb327495d20d25a2de5a088dbb543a6/Pillow-9.0.1.tar.gz
...
%prep
%setup -q -n Pillow-9.0.1
cd %{_builddir}/Pillow-9.0.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643906798
...
cp %{_builddir}/Pillow-9.0.1/Tests/fonts/DejaVuSans/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-pillow/3d95e2c3b731545390f6888a3214cf7b51fb7971
cp %{_builddir}/Pillow-9.0.1/Tests/fonts/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-pillow/9deb27f8f5fea69a2ab1624ed0698a0c8168ed49
cp %{_builddir}/Pillow-9.0.1/Tests/icc/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-pillow/371117588643c602bb8f15b280424e938c34c369
cp %{_builddir}/Pillow-9.0.1/src/thirdparty/raqm/COPYING %{buildroot}/usr/share/package-licenses/pypi-pillow/b321c557da16c1b66cb89d4a90fa63b5800966cb
